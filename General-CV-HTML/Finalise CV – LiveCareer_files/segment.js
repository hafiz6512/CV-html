...
var writeKey="i5cQ4Jikw0E7WqRUE5VabA1uQ2eyJVgl",segment_portal_name=null,integrations={"All":false,"Mixpanel":true,"Segment.io":true}
"undefined"!=typeof SEGMENT_EVENTS_TO_ALL&&SEGMENT_EVENTS_TO_ALL&&(integrations={"Qualaroo":false,"Inspectlet":false,"Google Analytics":false}),APP.segment=function(e){var t=function(t){if(e.setMixpanelPropsCookie(0),"function"==typeof segmentReady&&!t)try{segmentReady()}catch(e){console.log(e)}_segmentFirePageLoadEvent&&TrackEvents("page")},n=function(e){var t={},n=JSON.parse(e)
